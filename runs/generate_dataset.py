...
def run(opt):
    ...
    # check if datasets are correctly created by testing on handcrafted architectures - REMOVE ALL OF THIS
    ...
    #
    #
    #         symmetry['train_img'].append(tmp_img.astype(np.uint8))
    #         symmetry['train_gt'].append(tmp_gt.astype(np.uint8))
    #
    #     symmetry['train_img'] = [tmp for tmp in np.concatenate(symmetry['train_img'])[:int(dataset.num_images_training), :, :]]
    #     symmetry['train_gt'] = [tmp for tmp in np.concatenate(symmetry['train_gt'])[:int(dataset.num_images_training), :, :]]
    #
    #     # VALIDATION SET
    ...
    #         '''
    #
    #         symmetry['val_img'].append(tmp_img.astype(np.uint8))
    #         symmetry['val_gt'].append(tmp_gt.astype(np.uint8))
    #     symmetry['val_img'] = [tmp for tmp in np.concatenate(symmetry['val_img'])[:int(np.maximum(dataset.num_images_val, 1)), :, :]]
    #     symmetry['val_gt'] = [tmp for tmp in np.concatenate(symmetry['val_gt'])[:int(np.maximum(dataset.num_images_val, 1)), :, :]]
    #
    #     # TEST SET
    #     print("TEST SET")
    #     sys.stdout.flush()
    ...
    #         '''
    #
    #         symmetry['test_img'].append(tmp_img.astype(np.uint8))
    #         symmetry['test_gt'].append(tmp_gt.astype(np.uint8))
    #     symmetry['test_img'] = [tmp for tmp in np.concatenate(symmetry['test_img'])[:int(dataset.num_images_test), :, :]]
    #     symmetry['test_gt'] = [tmp for tmp in np.concatenate(symmetry['test_gt'])[:int(dataset.num_images_test), :, :]]
    #
    #     # Write Ground truth
    #     print("WRITTING GROUNDTRUTH")
    #     sys.stdout.flush()
    #
    #     dataset.create_tfrecords_from_numpy(symmetry)
    #
    #     print("----------------")
    #     sys.stdout.flush()
