...
class Dataset(object):
    ...
    def __init__(self, id, name, output_path, create=False):
...
def get_datasets(create, output_path):
    ...
    opt_handle = Dataset(idx, "data", output_path, create=create)
